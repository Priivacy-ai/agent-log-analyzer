    ...
    <main class="shell">
      <section class="report" id="report">
        ...
        <div class="upsell" id="download-report-section">
          ...
          <p class="upsell-lede">This report already used target-sized recent logs per supported agent source. The extended download gives you the same sanitized findings in a portable Markdown file for review, sharing, or saving with your project notes.</p>
