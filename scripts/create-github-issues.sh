...
create_issue "Rename launch host away from Claude-branded subdomain" "subissue,security" "Parent: $EPIC_SECURITY\n\nUse analyzer.spec-kitty.ai for public launch copy. Keep any Claude-branded host only as a compatibility redirect unless brand review explicitly approves it."
