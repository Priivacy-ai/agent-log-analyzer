...
| FR-005 | Proposed | The registry MUST seed entries for all 20 named SDD tools: Spec Kitty, GitHub Spec Kit, OpenSpec, Kiro, BMAD-METHOD, GSD, Spec Workflow MCP, SDD Pilot, Spec-Driven Develop, spec2ship, ChatDev, PAUL, fspec, whenwords, Intent, Cognition/Devin, Microsoft Agent Framework, Tessl, Agentic Code, CodeSpeak. |
