...
| NFR-005 | First paint of the new sections does not measurably regress report page render. | Adds < 5 ms over a representative fixture report on a developer laptop; verified by a manual measurement note in the PR. | Approved |
