...
2. The analyzer selects recent logs per supported source, currently Claude Code, Codex, and OpenCode, targeting roughly 5 MB total per source, parses and redacts them locally, and writes `agent-analyzer-report.json`.
